...
> **A procedure, not a skill** — see [`README.md`](README.md). Sole writer of the sweep checkpoint, per [`ownership.md`](../ownership.md).
...
slice from it is [`sweep-checkpoint.md`](../sweep-checkpoint.md).**
...
1. Read `sweeps` from `.claude/workflow.json`, falling back to
   `.claude/sweeps.json`.
2. Resolve each scope's slice per
   [`sweep-checkpoint.md`](../sweep-checkpoint.md#reading-a-checkpoint).
