...
Who may write the record is [`ownership.md`](ownership.md); what the record holds
is [`record-contract.md`](record-contract.md); the rules every sweep narrows by
are [`sweep-checkpoint.md`](sweep-checkpoint.md). This file is about the **shape**
...
[`sweep-checkpoint.md`](sweep-checkpoint.md#four-rules-and-they-are-the-whole-value):
...
again. This block is written into `record.audits`, which is committed and
