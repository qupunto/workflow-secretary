...
| `ws-release` | `--ws-release` | Decides that a version ships — once the roadmap marks a milestone done, or once it has declared an end to milestones and the release is maintenance on evidence — and asks before anything is published |
