...
the codebase: `--tools` owns `record.tooling.catalog` and hands it over, and this page is the
...
this skill and `--stocktake` cannot reach different conclusions about the same repo.
